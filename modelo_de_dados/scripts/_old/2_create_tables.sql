...
ALTER TABLE USERS DROP CONSTRAINT CK_USER_PERMISSION ;

ALTER TABLE USERS ADD CONSTRAINT CK_USER_PERMISSION CHECK ( PERMISSION IN (1, 2, 3, 4)) ;

COMMENT ON COLUMN USERS.PERMISSION
IS
  '1: Normal Public, 2: Editor/Writer, 3: Administrator, 4: Investidor' ;