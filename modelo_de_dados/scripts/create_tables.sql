...
ALTER TABLE COMMENTS ADD CONSTRAINT COMMENTS_POST_FK FOREIGN KEY ( POST_ID ) REFERENCES POST ( ID_POST ) ;

ALTER TABLE COMMENTS ADD CONSTRAINT COMMENTS_USER_FK FOREIGN KEY ( USER_ID ) REFERENCES "USER" ( ID_USER ) ;

ALTER TABLE COMMENT_LOG ADD CONSTRAINT COMMENT_LOG_COMMENTS_FK FOREIGN KEY ( COMMENTS_ID ) REFERENCES COMMENTS ( ID_COMMENT ) ;
